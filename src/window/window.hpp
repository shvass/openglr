...
public:
    ...
    inline void setFrameLimit(float fps = 60) { minFrameDelay = 1000.0F / fps; };


    void resize(int width, int height);

    /// @brief toggle cusor to switch into game mode for infinite mouse plane
    void toggleCursor();
...
private:
    ...
    /**
     * @brief  runLoop for renderThread
     * 
